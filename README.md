...
You can try out CodeCast by visiting the [live demo](https://code-cast-code-editor.vercel.app/). Create or join a room and start collaborating with others in real time!
### DEMO VIDEO
...
1. Open https://code-cast-code-editor.vercel.app/
